...
auto read_verpack_txt(const path &, const char*, const char* )-> vector_of_pair_size_t;
auto substring_verpack_txt(const string & , const char*)-> deque<size_t>;


auto read_data_txt(const path & , const char* reg_expr_1  , const char* reg_expr_2, const char* reg_expr_3)-> new_multimap_data;
